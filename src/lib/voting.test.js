...
describe("voting progression helpers", () => {
  ...
  it("reads legacy binary completions and new structured responses", () => {
    markComplete(1, "a");
    markStationVote(2, {
      choice: "other",
      ageRange: "25-34",
      otherText: "I'd take a middle path.",
    });

    expect(readStoredResponse(1)).toEqual({ choice: "a" });
    expect(readStoredResponse(2)).toEqual({
      choice: "other",
      ageRange: "25-34",
      otherText: "I'd take a middle path.",
    });
  ...
  it("stores pending sync as a structured response object", () => {
    updatePendingSync(3, {
      choice: "other",
      ageRange: "18-24",
      otherText: "I'd say hello first.",
    });

    expect(readPendingSyncMap(SCENARIOS)[3]).toEqual({
      choice: "other",
      ageRange: "18-24",
      otherText: "I'd say hello first.",
    });
